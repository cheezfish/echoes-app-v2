// client/app.js - FINAL VERSION WITH STARTUP FIX
...
function initializeApp() {
    ...
    if ('geolocation' in navigator) {
        // <<< THIS IS THE FIX: Added the options object with a timeout >>>
...
function startLocationWatcher() {
    setInterval(forceRefreshLocation, 30000);
}
