// client/app.js - FINAL ROBUST VERSION

const API_URL = 'https://echoes-server.onrender.com';
const R2_PUBLIC_URL_BASE = 'https://pub-01555d49f21d4b6ca8fa85fc6f52fb0a.r2.dev';

// === CONSTANTS ===
const MAX_RECORDING_SECONDS=60,RADAR_RADIUS_METERS=100;

// === ICONS ===
const userLocationIcon=L.icon({iconUrl:"https://api.iconify.design/material-symbols:my-location.svg?color=%23007bff",iconSize:[32,32],iconAnchor:[16,32],popupAnchor:[0,-32]}),echoIconFresh=L.icon({iconUrl:"https://api.iconify.design/mdi:fire.svg?color=%23ffc107",iconSize:[32,32],iconAnchor:[16,16],popupAnchor:[0,-16]}),echoIconStable=L.icon({iconUrl:"https://api.iconify.design/material-symbols:graphic-eq.svg?color=%23dc3545",iconSize:[32,32],iconAnchor:[16,16],popupAnchor:[0,-16]}),echoIconFading=L.icon({iconUrl:"https://api.iconify.design/material-symbols:graphic-eq.svg?color=%236c757d",iconSize:[32,32],iconAnchor:[16,16],popupAnchor:[0,-16]});
...
// --- APP STATE ---
let map,mediaRecorder,audioChunks=[],currentUserPosition={lat:0,lng:0},currentBucketKey="",markers,userToken=null,loggedInUser=null,echoMarkersMap=new Map,userMarker,radarCircle;let recordingTimer;
...
function initializeApp() {
    ...
    w3wAddressEl.textContent = "Click the 'Find Me' button to start exploring.";
}
...
function setupEventListeners() {
    ...
    findMeBtn.addEventListener('click', handleFindMeClick); // <<< NEW
}
...
// === 4. GEOLOCATION (NOW USER-INITIATED) ===
...
function onLocationSuccess(position) {
    ...
    map.flyTo([currentUserPosition.lat, currentUserPosition.lng], 16); // Use flyTo for a smooth animation
    if (!userMarker) {
