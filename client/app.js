...
let mapContainer, w3wAddressEl, recordBtn, loginBtn, registerBtn, logoutBtn, welcomeMessage, authModal, closeModalBtn, authForm, modalTitle, modalSubmitBtn, modalError, usernameInput, passwordInput, refreshRadarBtn, clusterModal, closeClusterModalBtn, clusterEchoList, findMeBtn;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    w3wAddressEl = document.getElementById("w3w-address");
    ...
    refreshRadarBtn = document.getElementById("refresh-radar-btn");
    clusterModal = document.getElementById("cluster-modal");
    closeClusterModalBtn = document.querySelector("#cluster-modal .close-btn");
...
function updateUIAfterLogout(){welcomeMessage.textContent="",loginBtn.style.display="inline-block",registerBtn.style.display="inline-block",logoutBtn.style.display="none",recordBtn.disabled=!0, w3wAddressEl.textContent = "Click the 'Find Me' button on the map to start exploring.";}
...
// --- KICK EVERYTHING OFF ---
// initializeApp(); // We call this from DOMContentLoaded